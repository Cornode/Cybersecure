...
import com.cornode.iri.*;
import com.cornode.iri.controllers.*;
import com.cornode.iri.network.*;
...
import com.cornode.iri.conf.Configuration.DefaultConfSettings;
import com.cornode.iri.hash.Curl;
import com.cornode.iri.hash.PearlDiver;
import com.cornode.iri.model.Hash;
import com.cornode.iri.service.dto.AbstractResponse;
import com.cornode.iri.service.dto.AccessLimitedResponse;
import com.cornode.iri.service.dto.AddedNeighborsResponse;
import com.cornode.iri.service.dto.AttachToTangleResponse;
import com.cornode.iri.service.dto.ErrorResponse;
import com.cornode.iri.service.dto.ExceptionResponse;
import com.cornode.iri.service.dto.FindTransactionsResponse;
import com.cornode.iri.service.dto.GetBalancesResponse;
import com.cornode.iri.service.dto.GetInclusionStatesResponse;
import com.cornode.iri.service.dto.GetNeighborsResponse;
import com.cornode.iri.service.dto.GetNodeInfoResponse;
import com.cornode.iri.service.dto.GetTipsResponse;
import com.cornode.iri.service.dto.GetTransactionsToApproveResponse;
import com.cornode.iri.service.dto.GetTrytesResponse;
import com.cornode.iri.service.dto.RemoveNeighborsResponse;
import com.cornode.iri.utils.Converter;
import com.cornode.iri.utils.MapIdentityManager;
...
public class API {
    ...
    private cornode instance;

    public API(cornode instance, IXI ixi) {
    ...
    private HttpHandler addSecurity(final HttpHandler toWrap) {
        ...
        final List<AuthenticationMechanism> mechanisms = Collections.singletonList(new BasicAuthenticationMechanism("cornode Realm"));

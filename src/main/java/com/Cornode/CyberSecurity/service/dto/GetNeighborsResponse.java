package com.cornode.iri.service.dto;
...
public class GetNeighborsResponse extends AbstractResponse {
    ...
    static class Neighbor {
        ...
        public static Neighbor createFrom(com.cornode.iri.network.Neighbor n) {
    ...
    public static AbstractResponse create(final List<com.cornode.iri.network.Neighbor> elements) {
        GetNeighborsResponse res = new GetNeighborsResponse();
        res.neighbors = new Neighbor[elements.size()];
        int i = 0;
        for (com.cornode.iri.network.Neighbor n : elements) {

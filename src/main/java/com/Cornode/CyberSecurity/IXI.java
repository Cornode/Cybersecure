...
import com.cornode.iri.service.CallableRequest;
...
public class IXI {
    ...
    private static final ScriptEngine scriptEngine = (new NashornScriptEngineFactory()).getScriptEngine((classname) ->
            !"com.cornode.iri.IXI".equals(classname));
    */
    ...
    private final cornode cornode;

    public IXI() {
        cornode = null;
    }
    public IXI(cornode cornode) {

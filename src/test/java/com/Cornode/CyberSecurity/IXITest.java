...
import com.cornode.iri.service.dto.IXIResponse;
...
public class IXITest {
    ...
    public void init() throws Exception {
        ...
        /*
        final String testJs =
                "var Callable = Java.type(\"com.cornode.iri.service.CallableRequest\");\n" +
                        "print(\"hello world\");\n" +
                        "var IXIResponse = Java.type(\"com.cornode.iri.service.dto.IXIResponse\");\n" +
